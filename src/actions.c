...
/*   Updated: 2025/06/18 14:07:25 by vflorez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 3. Locks the meal_time_mutex to safely update `last_meal_time` 
 * and `meals_eaten`.
 ...
 * The philosopher's state is expected to be set 
	to SLEEPING prior to calling this,
